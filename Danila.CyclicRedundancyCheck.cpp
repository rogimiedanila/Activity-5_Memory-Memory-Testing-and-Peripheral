/*
 *    An error detection technique using a polynomial to generate a series of two 8-bit block check characters that represent the entire block of data.
 *    These block check characters are incorporated into the transmission frame and then checked at the receiving end.
 */
